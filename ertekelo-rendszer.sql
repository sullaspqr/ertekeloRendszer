...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Feb 13. 08:17
...
--
ALTER TABLE `ertekelesek`
  ADD CONSTRAINT `ertekelesek_ibfk_1` FOREIGN KEY (`screening_id`) REFERENCES `screening` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ertekelesek_ibfk_2` FOREIGN KEY (`szempont_id`) REFERENCES `szempont` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
